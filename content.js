// 标记content script已加载
window.outlookToNotionContentScriptLoaded = true;
...
${emailData.content || getMessage('notFound')}
    ...
    console.log('Extracted email content:', formattedContent);
...
console.log('Outlook to Notion content script loaded successfully');